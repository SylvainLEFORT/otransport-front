...
const AffectDriver = () => {
  ...
  useEffect(() => {
    axios.get('http://celia-tosic-server.eddi.cloud/projet-03-o-transport-back/public/api/admin/drivers', config)
      .then((res) => {
  ...
  const sendIDDriver = (readDriverId) => () => {
    axios.put(`http://celia-tosic-server.eddi.cloud/projet-03-o-transport-back/public/api/admin/deliveries/${id}/affect`, { id: readDriverId }, config)
      .then((response) => {
